...
- The retrofit lands with v0.7's cluster-index work, when the UI grows its registration and per-cluster surfaces; existing sections are restyled in the same pass.
