...
-- Deregistered clusters serve no cluster-scoped reads (#55, ADR-0026
-- amendment 2026-09-05): every current-state view filters deregistered
-- rows at the view level so all consumers inherit liveness. Column
-- lists are unchanged; CREATE OR REPLACE suffices.
...
WHERE clusters.deregistered_at IS NULL
